...
function et(e, t, n) {
	...
	let r = {
		...
		matter_acl_entry_unreadable: "The access list on {target} holds an entry this version of Device Links cannot read, and writing the list would replace the whole of it, so the {cluster} binding from {device} was not written and nothing on the device was changed. Report this with a diagnostics download: it means {target} keeps something in its access list that this integration has not been taught about.",
