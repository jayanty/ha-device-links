...
function X(e) {
	return (t, n) => typeof n == "object" ? Y(e, t, n) : ((e, t, n) => {
...
var Q = "0.0.1", $ = class extends J {
	...
	render() {
      ...
      <div class="content">
        <div class="card">
          <h2>Device Links</h2>
          <p class="secondary">Panel version ${Q}.</p>
        </div>
      </div>
    `;
	}
};
Z([X({ attribute: !1 })], $.prototype, "hass", void 0), Z([X({
	type: Boolean,
	reflect: !0
})], $.prototype, "narrow", void 0), Z([X({ attribute: !1 })], $.prototype, "route", void 0), Z([X({ attribute: !1 })], $.prototype, "panel", void 0), $ = Z([_e("device-links-panel")], $);
//#endregion
export { Q as BUNDLE_VERSION, $ as DeviceLinksPanel };
